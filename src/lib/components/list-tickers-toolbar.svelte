...
<div class="flex lg:flex-row justify-between sm:flex-col">
    ...
    <div class="flex lg:flex-row sm:flex-col">
        <div class="select-theme flex flex-col mr-2 lg:w-64 sm:w-full sm:mt-2">
        ...
        <div class="select-theme flex flex-col lg:w-52 sm:mt-2 sm:w-full">
